...
async function startMining(settings) {
  ...
  // there is nothing to download or version-gate. The exception is SRBMiner-Multi,
  // which is a separate closed-source binary the operator installed themselves --
  ...
  // asked for (no pearl_core.node and no SRBMiner). That is the expected state
