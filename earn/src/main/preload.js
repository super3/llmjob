...
contextBridge.exposeInMainWorld('llmjob', {
  ...
  getBalance: (address, pool) => ipcRenderer.invoke('balance:get', address, pool),
  getMdlBalance: (prlAddress, mdlAddress, pool) => ipcRenderer.invoke('balance:getMdl', prlAddress, mdlAddress, pool),
