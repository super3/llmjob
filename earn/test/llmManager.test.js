...
describe('LlmManager', () => {
  ...
  test('flips to ready once on the listening line and emits stats for tokens/sec', () => {
    ...
    expect(stats).toHaveBeenCalledWith({ tokensPerSec: 162.02, promptTokensPerSec: null, tokens: 200 });
    ...
    expect(stats).toHaveBeenCalledWith({ tokensPerSec: null, promptTokensPerSec: 1840, tokens: 900 });
